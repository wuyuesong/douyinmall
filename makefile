...
.PHONY:	gen-frontend
gen-frontend:
	@cd app/frontend && cwgo server --type HTTP --idl ../../idl/frontend/home.proto  --service frontend -module github.com/wuyuesong/gomall -I ../../idl

.PHONY:	gen-auth-page
gen-auth-page:
	@cd app/frontend && cwgo server --type HTTP --idl ../../idl/frontend/auth_page.proto  --service frontend -module github.com/wuyuesong/gomall -I ../../idl
...
gen-product-page:
	@cd app/frontend && cwgo server --type HTTP --idl ../../idl/frontend/product_page.proto  --service frontend -module github.com/wuyuesong/gomall -I ../../idl

.PHONY:	gen-category-page
gen-category-page:
	@cd app/frontend && cwgo server --type HTTP --idl ../../idl/frontend/category_page.proto  --service frontend -module github.com/wuyuesong/gomall -I ../../idl
